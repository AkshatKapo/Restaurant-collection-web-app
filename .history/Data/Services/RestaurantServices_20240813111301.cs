using MySql.Data.MySqlClient; // Import the MySQL client library for database operations
using Restaurant_Collection.Data.Models; // Import the namespace containing the Restaurant model

namespace Restaurant_Collection.Data.Services
{
    // This class provides services related to restaurants, including adding, deleting, and retrieving restaurant data.
